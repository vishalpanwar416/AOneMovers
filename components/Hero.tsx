  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-blue-900/90 via-primary/60 to-white"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 md:py-32">
        <div className="text-center">
          ...
          >
            <div className="rounded-3xl p-4 sm:p-6 md:p-8 bg-white/90 backdrop-blur-md border border-white/60 shadow-2xl transition-all sm:hover:scale-105">
              <div className="text-3xl sm:text-5xl font-extrabold text-gray-900 mb-2 sm:mb-3">500+</div>
              <div className="text-gray-600 text-xs sm:text-sm font-semibold leading-snug">Happy Moves</div>
            </div>
            <div className="rounded-3xl p-4 sm:p-6 md:p-8 bg-white/90 backdrop-blur-md border border-white/60 shadow-2xl transition-all sm:hover:scale-105">
              <div className="text-3xl sm:text-5xl font-extrabold text-gray-900 mb-2 sm:mb-3">98%</div>
              <div className="text-gray-600 text-xs sm:text-sm font-semibold leading-snug">Satisfaction</div>
            </div>
            <div className="rounded-3xl p-4 sm:p-6 md:p-8 bg-white/90 backdrop-blur-md border border-white/60 shadow-2xl transition-all sm:hover:scale-105">
              <div className="text-3xl sm:text-5xl font-extrabold text-gray-900 mb-2 sm:mb-3">24/7</div>
              <div className="text-gray-600 text-xs sm:text-sm font-semibold leading-snug">Support</div>
            </div>
          </motion.div>
        </div>
      </div>
