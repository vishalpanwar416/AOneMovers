...
export default function Reviews() {
  ...
  return (
    <section id="reviews" className="py-16 sm:py-20 bg-gradient-to-br from-blue-50 via-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="max-w-6xl mx-auto glass-card rounded-3xl p-6 sm:p-8 shadow-3xl border border-white/40 backdrop-blur-xl"
        >
